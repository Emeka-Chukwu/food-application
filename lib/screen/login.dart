    ...
    return Scaffold(
      ...
      body: Form(
        ...
        child: Container(child:
          ...
          } else if (state is UserAuthenticatedError) {
            print(state);
            return LoginDetails();
          }
          return LoginDetails();
                ...
                child: Padding(
                    ...
                    child: TextFormField(
                        ...
                        onSaved: (String email) =>
                            usersCubit.userRespositories.getEmail(email),
                        validator: (String value) =>
                            usersCubit.userRespositories.validateString(value),
                ...
                child: Padding(
                    ...
                    child: TextFormField(
                        ...
                        onSaved: (String password) =>
                            usersCubit.userRespositories.getPassword(password),
                ...
                child: Column(
                  ...
                  Padding(
                    ...
                    child: GestureDetector(
                        onTap: () => usersCubit.loginRestaurantUser(context),
                        child: Container(
                          padding: const EdgeInsets.symmetric(
